...
<div class="right">
	...
	<div class="search">
		<form method="get"
			action="${pageContext.request.contextPath }/user/list.jhtml">
			...
			<span>用户名：</span> <input name="queryname" class="input-text"
				...
				href="${pageContext.request.contextPath}/user/add.jhtml">添加用户</a>
		</form>
	</div>
	<!--用户-->
		...
		<c:forEach var="user" items="${userList }" varStatus="status">
			<tr>
				...
				<td><span><a class="viewUser" 
					href="${pageContext.request.contextPath }/user/view/${user.userCode}"><img
							src="${pageContext.request.contextPath }/resources/images/read.png"
							alt="查看" title="查看" /></a></span> <span><a class="modifyUser"
						href="javascript:;" userid=${user.id } username=${user.userName }><img
							src="${pageContext.request.contextPath }/resources/images/xiugai.png"
							alt="修改" title="修改" /></a></span> <span><a class="deleteUser"
						href="${pageContext.request.contextPath }/user/delete/${user.userCode}"><img
							src="${pageContext.request.contextPath }/resources/images/schu.png"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/resources/js/userlist.js"></script>
